...
<head>
	<meta charset="UTF-8">
	<title>Welcome to Perpustakaan STMIK Palangkaraya!</title>
...
<body>
	...
	<header>
		...
		<div class="heroe">
			...
			<h1>Welcome to Perpustakaan STMIK Palangkaraya</h1>

			<h2>Aplikasi ini dibangun untuk kuliah Pemrograman Framework</h2>
